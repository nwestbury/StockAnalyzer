...
class ANNBot(BaseBot):

    """
    Artificial Neural Net Bot: finds linear patterns in all
    the market data.
    """
    def __init__(self):
        BaseBot.__init__(self)
        self.mlp = MLPRegressor(solver='adam', random_state=0)
        self.mlpc = MLPClassifier(solver='adam', random_state=0)
    ...
    def train(self):
        ...
        self.mlp.fit(train_data, train_targets)
